...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="<?= site_url('admin/periods/update/' . $periode['id_periode']) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= session('errors.deskripsi') ? 'is-invalid' : '' ?>" 
                              ...
                              name="deskripsi" 
                              rows="3"
                              placeholder="Deskripsi periode survei (opsional)"><?= old('deskripsi', $periode['deskripsi'] ?? '') ?></textarea>
                    <div class="invalid-feedback">
